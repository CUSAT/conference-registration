 ...
 */
	...
	function echoToConsole( $messageIn, $option_tags ) {
		...
		if( $option_tags == true ) {
			echo( "<script>console.log( '" . addslashes( $str_pdweekName ) . "\'s Debug Output: " . addslashes( $message ) . "' );</script>\n" );
		} else {
			echo( "console.log( '" . addslashes( $str_pdweekName ) . "\'s Debug Output: " . addslashes( $message ) . "' );" );
		}// end if statement
