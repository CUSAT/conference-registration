...
if( $emailnew == "" ) {
	...
	$subject = "{$str_pdweekName} registration";

	if( !isset( $_POST['ctlMember'] ) ) {
		$message = "<p>Hello " . htmlentities( $firstname ) . "</p>\r\n
		<p>Please click on the link below to continue your registration process for {$str_pdweekName} {$str_currentYear}.</p>\r\n
		...
		$message = "<p>Hello " . htmlentities( $firstname ) . "</p>\r\n
		<p>You are recieving this email because you have been manually added into the {$str_pdweekName} Registration System.</p>\r\n
